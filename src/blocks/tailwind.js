...
import { source as personalizationTitle } from './data/personalization-title';
import { source as personalizationTitleIcon } from './data/icons/personalization-title';
import { source as personalizationCta } from './data/personalization-cta';
import { source as personalizationCtaIcon } from './data/icons/personalization-cta';
import { source as personalizationPrice } from './data/personalization-price';
import { source as personalizationPriceIcon } from './data/icons/personalization-price';
var getSvgHtml = function (svg) {
...
var sources = [
    ...
    },
    {
        ...
        class: '',
        label: personalizationTitleIcon,
        content: personalizationTitle,
        category: 'Personalization',
    },
    {
        id: 'personalization-cta',
        class: '',
        label: personalizationCtaIcon,
        content: personalizationCta,
        category: 'Personalization',
    },
    {
        id: 'personalization-price',
        class: '',
        label: personalizationPriceIcon,
        content: personalizationPrice,
        category: 'Personalization',
    },
];
export default (function (editor, options) {
    ...
    sources.forEach(function (s) {
        bm.add(s.id, {
            ...
            attributes: { class: "".concat(s.class, " block-full-width") },
            content: s.content,
